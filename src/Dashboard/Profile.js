...
const Profile = () => {
    ...
    return (
        <div className='shadow-md px-5 text-start w-10/12 mx-auto'>
            <div className='col-span-2'>
                <div className='flex justify-between items-center'>
                <p className='text-orange-600 text-lg font-semibold mt-10'>WelCome Back</p>
                <p>{loggedInUser.role} Dashboard</p>
                </div>
                <div className="p-6 sm:p-12 dark:bg-gray-900 dark:text-gray-100">
                    <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        <img src={loggedInUser.image} alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" />
                        <div className="flex flex-col">
                            
                            <div className='flex items-center'>
                            <h4 className="text-lg font-semibold text-center md:text-left">{loggedInUser.name}</h4>
                            {
                            ...
                            <p className="dark:text-gray-400">{loggedInUser.email}</p>
                        </div>
                    </div>
